 ...
 *
 * All help text is displayed in a QTextEdit so any text that can be
 ...
 * to use HTML then you will need to set the Type flags to HTML rather than
 ...
 *   multi-page versions.
 *
 *   \note The dialogs attempt to resize appropriately for the supplied text. However
 *         you can change the dialog size via the QWidget::setFixedSize(const QSize).
 */
// clang-format on

//! \class BaseHelpDialog helpdialogs.h
//! \brief Base Help Dialog class.
class HELP_SHARED_EXPORT BaseHelpDialog : public QDialog
{
public:
...
/*!
  ...
  \endcode
 */
class HELP_SHARED_EXPORT SimpleHelpDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
...
/*!
  ...
  \endcode
 */
class HELP_SHARED_EXPORT ExtendedHelpDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
 ...
 */
class HELP_SHARED_EXPORT ExtendedHelpWithTabsDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
...
/*!
  ...
  might be preferable.
 */
class HELP_SHARED_EXPORT ExtendedHelpWithComboDialog : public BaseHelpDialog
{
  Q_OBJECT
public:
